...
function paperHeader(p, subject, num) {
  return `<header class="paper-head"><div class="eyebrow">DAILY LEARNING PACK <span>${num} / 03 · ${subject.toUpperCase()} · 15 MIN</span></div><h1>${esc(p[subject].title)}</h1><p class="paper-topic">${esc(p.topic)}</p><div class="name-line">Name __________________________ <span>Date _______________</span></div></header>`;
}
